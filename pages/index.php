            ...
            <article> 
                ...
                <section class="banner mask-overlay pad-120 white-clr">
                    <div class="container theme-container rel-div">
                        <img class="pt-10 effect animated fadeInLeft" alt="" src="<?php echo $lib->generate_url('assets/img/icons/icon-1.png'); ?>" />
                                    ...
                                    <form id="trackingForm">
                                        <div class="col-md-7 col-sm-7">
                                            <div class="form-group">
                                                <input type="text" id="trackcode" placeholder="Enter your product ID" required class="form-control box-shadow">
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="about-us">
                                    ...
                                    <ul class="feature">
                                        <li> 
                                            <img alt="" src="<?php echo $lib->generate_url('assets/img/icons/icon-2.png'); ?>" class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s" /> 
                                        ...
                                        <li> 
                                            <img alt="" src="<?php echo $lib->generate_url('assets/img/icons/icon-3.png'); ?>" class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s" /> 
                                            <div class="feature-content wow rotateInDownRight" data-wow-offset="50" data-wow-delay=".30s"> 
                                        ...
                                        <li> 
                                            <img alt="" src="<?php echo $lib->generate_url('assets/img/icons/icon-4.png'); ?>" class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s" /> 
                                            <div class="feature-content wow rotateInDownRight" data-wow-offset="50" data-wow-delay=".30s"> 
                            ...
                            <div class="col-md-6 text-center">
                                ...
                                <img alt="" src="<?php echo $lib->generate_url('assets/img/block/about-img.png'); ?>" class="wow slideInRight" data-wow-offset="50" data-wow-delay=".20s" />
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="calculate pt-100">
                    <div class="theme-container container">  
                        ...
                        <div class="row">
                            <div class="col-md-6 text-center">
                                <img src="<?php echo $lib->generate_url('assets/img/block/Courier-Man.png'); ?>" alt="" class="wow slideInLeft" data-wow-offset="50" data-wow-delay=".20s" />
                            </div>
                            <div class="col-md-6">   
                    ...
                    <div class="theme-container container">               
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                ...
                                <div class="steps-content wow fadeInLeft" data-wow-offset="50" data-wow-delay=".25s"> 
                                    <h2 class="title-3">Delivery</h2> 
                                    <p class="gray-clr">Duis autem vel eum iriur <br> hendrerit in vulputate</p>                                            
                                </div>  
                            </div>
                        </div>
                    </div>
                    <div class="step-img wow slideInRight" data-wow-offset="50" data-wow-delay=".20s"> <img src="<?php echo $lib->generate_url('assets/img/block/step-img.png'); ?>" alt="" /> </div>
                </section>
                <!-- /.Steps -->
                        ...
                        <div class="row">
                            <div class="col-md-11 col-md-offset-1">
                                ...
                                <div class="delivery-img pt-10">
                                    <img alt="" src="<?php echo $lib->generate_url('assets/img/block/delivery.png'); ?>" class="wow slideInLeft" data-wow-offset="50" data-wow-delay=".20s"/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="testimonial-slider no-pagination pad-120">
                            <div class="item">
                                <div class="testimonial-img darkclr-border theme-clr font-2 wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s">
                                    <img alt="" src="<?php echo $lib->generate_url('assets/img/block/testimonial-1.png'); ?>" />
                                    <span>,,</span>
                                </div>
